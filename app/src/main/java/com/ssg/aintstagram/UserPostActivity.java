...
public class UserPostActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null){
            ...
            if(extras == null){
                ...
                post_pos = extras.getInt("pos");
                post_pos_record = extras.getInt("record");
            }
        }

        if(username == null || post_pos == -1 || post_pos_record == -1){
            finish();
        }
    ...
    public void setBtn() {
        ...
        ImageButton camera = (ImageButton) findViewById(R.id.button_to_camera);
        camera.setVisibility(View.INVISIBLE);
        ImageButton chat = (ImageButton) findViewById(R.id.button_to_chat);
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()) {
                    case R.id.button_to_search:
                        Intent searchintent = new Intent(UserPostActivity.this, SearchActivity.class);
                        searchintent.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                        startActivity(searchintent);
                        break;

                    case R.id.button_to_add:
                        permissionCheck = ContextCompat.checkSelfPermission(UserPostActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE);
                        if (permissionCheck == PackageManager.PERMISSION_DENIED) {
                            ActivityCompat.requestPermissions(UserPostActivity.this, PERMISSIONS, 0);
                        } else {
                    ...
                    case R.id.button_to_info:
                        Intent intent = new Intent(UserPostActivity.this, ProfileActivity.class);
    ...
    public void getPosts(){
        ...
        final PostTypeQuery q = PostTypeQuery.builder().accessToken(Token).name(username).build();
                                        ...
                                        public void onPostClick(final int pos, int choice) {
                                            switch(choice){
                                                ...
                                                case 1:
                                                    ...
                                                    AlertDialog.Builder builder = new AlertDialog.Builder(UserPostActivity.this);
                                                ...
                                                case 2:
                                                    ...
                                                    break;
                                                case 3:
                                                    Intent commentIntent = new Intent(UserPostActivity.this, CommentActivity.class);
